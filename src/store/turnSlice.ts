...
export const createTurnSlice: StateCreator<GameState, [['zustand/devtools', never]], [], TurnSlice> = (set, get) => ({
  ...
  passTurn: () => {
    ...
    set({ playerTurn: playerTurn.id === lastActivePlayer.id ? activePlayers[0] : activePlayers[currentActivePlayerIndex + 1] }, undefined, 'turn/passTurn')
  }
})
